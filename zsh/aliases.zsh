...
alias is='playerctl metadata --format "Now playing: {{artist}} - {{title}} - {{album}}"'
alias q="exit"
# invoke yazi
alias a="y"
alias f="fzf"
...
alias gl="cd $HOME/.config/labwc && ranger"
alias gL="cd $HOME/.config/labwc && ranger"
alias gn="cd $HOME/.config/nvim/lua/user/ && ranger"
alias gM="cd /run/media && ranger"
alias gm="cd $HOME/media/music/ && ranger"
...
alias gr="cd $HOME/.config/ranger && yazi"
# alias gs="cd $HOME/scripts/stow && ranger"
alias gs="cd $HOME/media/photos/screenshots && ranger"
alias gu="cd $HOME/media/music/sort && ranger"
alias gv='cd /var'
alias gw='cd ~/.config/labwc && ranger'
alias gz="cd $HOME/.config/zsh && ranger"
alias gZ="cd $HOME/.local/share/zap/plugins && ranger"
alias gy="cd $HOME/.config/yazi && ranger"
...
alias nl='nvim ~/.config/labwc/rc.xml'
...
alias ny='nvim ~/.config/yazi/keymap.toml'
alias nz='nvim ~/.config/zsh/aliases.zsh'
alias syn="syncthing &"
alias sn='sudo nvim'
...
alias ppsmem='ps auxf | sort -nr -k 4 | head -8'
